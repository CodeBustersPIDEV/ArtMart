 ...
 * @author rymae
 */
public class AdminCardController implements Initializable {
    ...
    private AdminBoardController controller = new AdminBoardController();
    ...
    public void setReadyProduct(ReadyProduct param, AdminBoardController controller) throws SQLException {
        this.p = param;
